 ...
 <script src="static/bootstrap-3.3.7-dist/js/bootstrap.min.js"></script>
  ...
  <div style="border:1px solid #E7E7E7; width:1000px; margin:0 auto;">
    ...
    <table class="table table-bordered">
     <thead><tr><th>姓名</th><th>电话号</th><th>钱数（元）</th><th>斤数（斤）</th><th>类型</th><th>结账日期</th><th>操作</th></tr></thead>
     <tbody>
    ...
    <tr>
	    ...
	    <td>
		    ...
		    <li class="active" ><a href="/AccountBook/books/delete?id=${book.id }">删除</a></li>
		    </ul>
	    </td>
    </tr>
    </c:forEach>
